...
The hotkey works in both **canvas mode** and **dashboard mode** thanks to the CSS Hide/Show pattern (see [CRITICAL_CSS_HIDE_SHOW_FIX.md](../troubleshooting/CRITICAL_CSS_HIDE_SHOW_FIX.md)).
...
Per [ROLES_TEAMS_COLLECTIONS.md](../guides/ROLES_TEAMS_COLLECTIONS.md):
...
- [STATE_MANAGEMENT.md](../architecture/STATE_MANAGEMENT.md) - Jotai atoms and state management patterns
- [ROLES_TEAMS_COLLECTIONS.md](../guides/ROLES_TEAMS_COLLECTIONS.md) - Access control rules
- [URL_ROUTING.md](../architecture/URL_ROUTING.md) - URL patterns for navigation
- [CRITICAL_CSS_HIDE_SHOW_FIX.md](../troubleshooting/CRITICAL_CSS_HIDE_SHOW_FIX.md) - Why hotkey works in both modes
