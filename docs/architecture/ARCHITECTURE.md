...
> **See also:** [Roles, Teams & Collections](../guides/ROLES_TEAMS_COLLECTIONS.md) for the complete schema and access control documentation.
...
All sensitive configuration supports Docker secrets via the `_FILE` suffix. See [Docker Secrets](../deployment/DOCKER_SECRETS.md) for complete documentation.
