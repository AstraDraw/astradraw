...
- [ ] `just check` passes
- [ ] Feature tested in browser at `https://draw.local` if relevant
...
### For Comment System Item
Mark as resolved in `docs/planning/COMMENT_SYSTEM_IMPLEMENTATION_PLAN.md`:
```markdown
